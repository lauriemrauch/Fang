...
function fang_more_link( $more_link, $more_link_text ) {
    return str_replace( $more_link_text, __('Read the full article &rarr;','fang'), $more_link ) . '';
}

add_filter( 'the_content_more_link', 'fang_more_link', 10, 2 );

/**
 * Make video embeds responsive
 */
 
 function fang_embed_html( $html ) {
    return '<div class="video-wrapper">' . $html . '</div>';
}
 
add_filter( 'embed_oembed_html', 'fang_embed_html', 10, 3 );
add_filter( 'video_embed_html', 'fang_embed_html' ); // Jetpack
