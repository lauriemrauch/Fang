	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="container">
			<?php if ( is_active_sidebar( 'footer-widget-1' ) || is_active_sidebar( 'footer-widget-2' ) || is_active_sidebar( 'footer-widget-3' ) || is_active_sidebar( 'footer-widget-4' ) ) : 
				...
				?>
            <div id="footer-widgets" <?php fang_footer_widget_class(); ?>>
			...
			<div class="site-info">
                ...
                <p class="credits"><?php printf( __( 'Theme: %1$s by %2$s.', 'fang' ), 'Fang', '<a href="http://codediva.com" rel="designer">Code Diva</a>' ); ?></p>
			</div><!-- .site-info -->
		</div><!-- .container -->
	</footer><!-- #colophon -->
</div><!-- #page -->
