...
function fang_setup() {
	...
	load_theme_textdomain( 'fang', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'fang' ),
		'social' => __( 'Social Menu', 'fang' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'fang_custom_background_args', array(
...
function fang_scripts() {
	...
	wp_enqueue_style('font-awesome', 'http://maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css');
